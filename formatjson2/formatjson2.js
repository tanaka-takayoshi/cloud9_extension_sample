define(function(require, exports, module) {
    ...
    module.exports = ext.register("ext/formatjson2/formatjson2", {
        ...
        commands: {
            "format2": {
                hint: "reformat 2 the current JSON document"
            }
        },
        ...
        format: function(indent) {
            ...
            try {
                ...
                util.alert("Invalid JSON", "The selection contains an invalid or incomplete JSON string", "Please correct the JSON and try again");
                return;
            }
